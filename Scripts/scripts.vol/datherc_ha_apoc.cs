...
newConfiguration( Armor,        LeftFoot,                      0.05);                                # 600
newConfiguration( Armor,        RightFoot,                     0.05);                                # 600
newConfiguration( Armor,        LeftCalf,                      0.10);                               # 1200
newConfiguration( Armor,        RightCalf,                     0.10);                               # 1200
newConfiguration( Armor,        LeftLeg,                       0.10);                               # 1200
newConfiguration( Armor,        RightLeg,                      0.10);                               # 1200
newConfiguration( Armor,        Pelvis,                        0.12);                               # 1440
newConfiguration( Armor,        Head,                          0.14);                               # 1680
newConfiguration( Armor,        LeftPod,                       0.12);                               # 1440
newConfiguration( Armor,        RightPod,                      0.12);                               # 1440
#                 -----
#                                                              1.00
...
defaultWeapons(   117,          117,             113,              107,                              126 ,              126);
defaultMountables(110,          204,             801,              307,            931,                   400,             830,                        910);

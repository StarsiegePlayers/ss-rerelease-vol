...
newHardPoint(     2,            X,               B,                Head,               2.0,                  3.25,           -1.2,           -40.0,    30.0, -45.0,             20);
newHardPoint(     3,            X,               B,                Head,               -2.0,                 3.25,           -1.2,           -45.0,    30.0, -20.0,             45);
#
#
#
#
...
newComponent(     Armor,        Armor,           none,                          12000 ,IDCOM_ARMOR           );
...
newComponent(     Head,         Head,            none,                           2380 ,IDCOM_HEAD            );                        # 0.34
newComponent(     LeftLeg,      LeftLeg,         Head,                            840 ,IDCOM_LEFT_LEG        );                        # 0.12
newComponent(     RightLeg,     RightLeg,        Head,                            840 ,IDCOM_RIGHT_LEG       );                        # 0.12
newComponent(     LeftCalf,     LeftCalf,        LeftLeg,                         840 ,IDCOM_LEFT_CALF       );                        # 0.12
newComponent(     RightCalf,    RightCalf,       RightLeg,                        840 ,IDCOM_RIGHT_CALF      );                        # 0.12
newComponent(     LeftFoot,     LeftFoot,        LeftCalf,                        630 ,IDCOM_LEFT_FOOT       );                        # 0.09
newComponent(     RightFoot,    RightFoot,       RightCalf,                       630 ,IDCOM_RIGHT_FOOT      );                        # 0.09
...
newConfiguration( Armor,        LeftFoot,                      0.06);                                   # 720
newConfiguration( Armor,        RightFoot,                     0.06);                                   # 720
newConfiguration( Armor,        LeftCalf,                      0.09);                                  # 1080
newConfiguration( Armor,        RightCalf,                     0.09);                                  # 1080
newConfiguration( Armor,        LeftLeg,                        0.1);                                  # 1200
newConfiguration( Armor,        RightLeg,                       0.1);                                  # 1200
newConfiguration( Armor,        Head,                           0.5);                                  # 6000
#                 -----
#                                                              1.00
...
defaultMountables(143,          230,             805,              331,                931,                  428,            865,                   850);

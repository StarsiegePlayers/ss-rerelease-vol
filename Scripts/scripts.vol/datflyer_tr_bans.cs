...
flyerBase(	IDVEH_TR_BANS, "BANS",	"tr_bans.dts" ,	20.00 ,	65.00 ,	0.90 ,	2 ,	1485	);
...
newMountPoint(	5,	M,	FlyerBody,	Cloak,	thermalDiffuser	,	Sensors);						
...
newConfiguration( Armor,	FlyerBody,	0.2	);								
newConfiguration( Armor,	FlyerHead,	0.2	);								
newConfiguration( Armor,	LeftWing1,	0.06	);
newConfiguration( Armor,	RightWing1,	0.06	);
newConfiguration( Armor,	LeftWing2,	0.06	);
newConfiguration( Armor,	RightWing2,	0.06	);
newConfiguration( Armor,	LeftEngine1,	0.15	);
newConfiguration( Armor,	RightEngine1,	0.15	);
newConfiguration( Armor,	Tail,		0.06	);
#	-----											
#	1											

#newConfiguration( LeftServos, LeftWing1, 0.33 );
#newConfiguration( LeftServos, LeftWing2, 0.33 );
#newConfiguration( LeftServos, LeftEngine1, 0.33 );
#newConfiguration( RightServos, RightWing1, 0.33 );
#newConfiguration( RightServos, RightWing2, 0.33 );
#newConfiguration( RightServos, RightEngine1, 0.33 );

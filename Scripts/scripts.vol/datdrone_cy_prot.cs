...
droneBase( IDVEH_CY_PROT, "CYPROT",    "cy_prot.dts", 5.00, 30.00 ,  0.85, 2 ,          1500);
...
newComponent( tankLeftPod,  tankLeftPod,  Body,  900.0,   IDCOM_LEFT_TREAD);
newComponent( tankRightPod, tankRightPod, Body,  900.0,   IDCOM_RIGHT_TREAD);

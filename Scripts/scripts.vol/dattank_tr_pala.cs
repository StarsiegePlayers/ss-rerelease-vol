...
tankBase(            IDVEH_TR_PALA,         "PALA",               "tr_pala.dts",                15.00 ,                     60.00 ,         0.90 ,          2 ,         2005);

#                    maxPosAcc              minPosVel             maxForPosVel      maxRevPosVel       (all_m/s)
tankPos(                             20.00 ,                3.00 ,           30.00 ,             -25.50);
...
newConfiguration(    Armor,                 Body,                                0.3);                                       # 2100
newConfiguration(    Armor,                 TankHead,                            0.2);                                       # 1400
newConfiguration(    Armor,                 LeftTread,                          0.25);                                       # 1750
newConfiguration(    Armor,                 RightTread,                         0.25);                                       # 1750
#                    -----
#                                                                               1.00
...
defaultWeapons(      129,                                      129);
defaultMountables(   109,                   202,                  802,              928,               410,                        810,           820,                   860);

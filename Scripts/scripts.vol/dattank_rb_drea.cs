...
tankBase(            IDVEH_RB_DREA,         "DREA",               "rb_drea.dts",                14.00 ,                     45.00 ,         0.70 ,          1 ,         2215);
...
newMountPoint(       5,                     M,                    tankLeftPod,      ECM,               ThermalDiffuser,            LaserTargeting,NanoRepair,  Battery,     Cloak,FieldStabilizer,
...
newMountPoint(       6,                     L,                    Body,             ECM,               ThermalDiffuser,            LaserTargeting,NanoRepair,  Battery,     Cloak,FieldStabilizer,
                                                                                    LifeSupport,       Capacitor,                  AgravGenerator,TurbineBoost,RocketBooster,     ammoPack              );
newMountPoint(       7,                     M,                    tankRightPod,     ECM,               ThermalDiffuser,            LaserTargeting,NanoRepair,  Battery,     Cloak,FieldStabilizer,
                                                                                    LifeSupport,       Capacitor,                  AgravGenerator,TurbineBoost,RocketBooster,     ammoPack              );
#                    Internal               Components
...
defaultMountables(   108,                   204,                  801,              927,               412,                        865,           830,                   885);

######################################################################
# datTank_cy_artl.cs
# Cybrid Artillery (non pilotable)
#
######################################################################
...
newHardPoint(     0 ,                 X,               T,                TankHead,       0.0,                    2.79,            1.44,           -25.0,       89.0,      -60.0,60.0);
...
newComponent(     Body,               Body,            none,                        875 ,IDCOM_BODY              );                         # 0.35
newComponent(     TankHead,           TankHead,        Body,                        625 ,IDCOM_HEAD              );                         # 0.25
newComponent(     LeftTread,          LeftTread,       Body,                        500 ,IDCOM_LEFT_TREAD        );                         # 0.20
newComponent(     RightTread,         RightTread,      Body,                        500 ,IDCOM_RIGHT_TREAD       );                         # 0.20

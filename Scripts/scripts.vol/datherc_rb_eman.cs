...
hercBase(              IDVEH_RB_EMAN,"EMAN",          "rb_eman.dts",                  10.0 ,                  40 ,          0.85 ,             1 ,        1730);
...
newConfiguration(      Armor,        LeftFoot,                      0.05);                                   # 375             385
newConfiguration(      Armor,        RightFoot,                     0.05);                                   # 375             385
newConfiguration(      Armor,        LeftCalf,                      0.08);                                   # 600             605
newConfiguration(      Armor,        RightCalf,                     0.08);                                   # 600             605
newConfiguration(      Armor,        LeftLeg,                       0.09);                                   # 675             660
newConfiguration(      Armor,        RightLeg,                      0.09);                                   # 675             660
newConfiguration(      Armor,        LeftPod,                       0.10);                                   # 750             605
newConfiguration(      Armor,        RightPod,                      0.10);                                   # 750             605
newConfiguration(      Armor,        Head,                          0.36);                                  # 2700             990
#                      -----
#                                                                   1.00
...
defaultMountables(     105,          204,             801,              306,                927,                  412,            840,                     830);

...
hercBase(         IDVEH_KN_TALO,"TALO",          "kn_talon.dts",                  5.0 ,                  30 ,             0.85 ,             3 ,        1250);

#                 maxPosAcc     minPosVel        maxForPosVel      maxRevPosVel        (all_m/s)
hercPos(                 20.00 ,           3.00 ,           40.00 ,              -20.00);

#                 minRotVel     maxRVSlow        maxRVFast         (all_deg/s)
hercRot(                  6.00 ,          80.00 ,             40.00);
...
#newHardPoint(    2,            L,               R,                Head,               1.5,                  -1.25,             1.0,            -60.0,      15.0, -60.0,             50);
#newHardPoint(    3,            L,               L,                Head,               -1.5,                 -1.25,             1.0,            -60.0,      15.0, -60.0,             50);
#
#
#
#
...
newComponent(     Armor,        Armor,           none,                           5500 ,IDCOM_ARMOR           );
newComponent(     LeftServos,   LeftServos,      none,                            800 ,IDCOM_LEFT_LEG_SERVOS );
newComponent(     RightServos,  RightServos,     none,                            800 ,IDCOM_RIGHT_LEG_SERVOS);

#                 External      Components
#                 id            type             parent            max_dmg             identity_tag          total internals =              4000
newComponent(     Pelvis,       Pelvis,          none,                            520 ,IDCOM_PELVIS          );                           # 0.13
newComponent(     Head,         Head,            Pelvis,                          600 ,IDCOM_HEAD            );                           # 0.15
newComponent(     LeftLeg,      LeftLeg,         Pelvis,                          400 ,IDCOM_LEFT_LEG        );                           # 0.10
newComponent(     RightLeg,     RightLeg,        Pelvis,                          400 ,IDCOM_RIGHT_LEG       );                           # 0.10
...
newComponent(     LeftFoot,     LeftFoot,        LeftLeg,                         200 ,IDCOM_LEFT_FOOT       );                           # 0.05
newComponent(     RightFoot,    RightFoot,       RightLeg,                        200 ,IDCOM_RIGHT_FOOT      );                           # 0.05
newComponent(     LeftPod,      LeftPod,         Head,                            440 ,IDCOM_LEFT_POD        );                           # 0.11
newComponent(     RightPod,     RightPod,        Head,                            440 ,IDCOM_RIGHT_POD       );                           # 0.11
...
newConfiguration( Armor,        LeftFoot,                      0.05);                                   # 275
newConfiguration( Armor,        RightFoot,                     0.05);                                   # 275
newConfiguration( Armor,        LeftCalf,                      0.10);                                   # 550
newConfiguration( Armor,        RightCalf,                     0.10);                                   # 550
newConfiguration( Armor,        LeftLeg,                       0.12);                                   # 660
newConfiguration( Armor,        RightLeg,                      0.12);                                   # 660
newConfiguration( Armor,        Pelvis,                        0.13);                                   # 715
newConfiguration( Armor,        Head,                          0.13);                                   # 715
newConfiguration( Armor,        LeftPod,                       0.16);                                   # 880
newConfiguration( Armor,        RightPod,                      0.04);                                   # 220
#                 -----
#                                                              1.00
...
defaultWeapons(   103,                        103);
defaultMountables(102,          203,             801,              304,                926,                  410,               865,                     850);

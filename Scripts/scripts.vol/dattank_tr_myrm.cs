...
tankBase(            IDVEH_TR_MYRM,         "MYRM",               "tr_myrm.dts",                 40.0 ,                      90.0 ,         0.95 ,          4 ,         3035);
...
newConfiguration(    Armor,                 Body,                               0.32);                                       # 4000
newConfiguration(    Armor,                 TankHead,                           0.08);                                       # 1000
newConfiguration(    Armor,                 LeftTread,                          0.30);                                       # 3750
newConfiguration(    Armor,                 RightTread,                         0.30);                                       # 3750
#                                                                               1.00
#
...
defaultWeapons(      120,                                      120);
defaultMountables(   113,                   200,                  801,              927,               412,                        914,           820,                   811);

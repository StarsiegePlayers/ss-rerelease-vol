...
hercBase(         IDVEH_CY_SHEP,"SHEP",          "cy_shep.dts",                   8.0 ,                  48 ,             1.00 ,             2 ,        1810);
...
hercAnim(         4.0,          14.0,            20.0,                               36);

#                 offsetX       offsetY          offsetZ
hercCpit(         0.0,          0.0,                            0.6);
...
defaultWeapons(   118,          118,             104,                               104);
defaultMountables(136,          228,             807,              332,                930,                  427,               845,                     850);

...
hercBase(         IDVEH_CY_GOAD,"GOAD",          "cy_goad.dts",                   8.0 ,                  35 ,          0.85 ,             1 ,        1600);
...
defaultWeapons(   102,                        102);
defaultMountables(132,          227,             806,              328,                929,                  432,            812,                     840);
`